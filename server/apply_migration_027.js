...
async function runSQL() {
    console.log('Aplicando migración 027 (agregar columna fecha_confirmada)...');
    
    const sqlPath = path.join(__dirname, 'migrations', '027_add_fecha_confirmada_to_seguimiento_pedidos.sql');

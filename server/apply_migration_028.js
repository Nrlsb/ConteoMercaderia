...
async function runSQL() {
    console.log('Aplicando migración 028 (crear tabla user_tintometrico_permissions)...');
    
    const sqlPath = path.join(__dirname, 'migrations', '028_create_user_tintometrico_permissions.sql');

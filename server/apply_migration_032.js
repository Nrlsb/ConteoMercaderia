...
async function runSQL() {
    console.log('Aplicando migración 032 (agregar columna price_list a la tabla users)...');
    
    const sqlPath = path.join(__dirname, 'migrations', '032_add_price_list_to_users.sql');

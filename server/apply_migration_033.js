...
async function runSQL() {
    console.log('Aplicando migración 033 (agregar columna num_id autoincremental a color_registrations)...');
    
    const sqlPath = path.join(__dirname, 'migrations', '033_add_num_id_to_color_registrations.sql');
    ...
    if (error) {
        ...
        console.log('¡Migración 033 aplicada con éxito!', data);
    }
}

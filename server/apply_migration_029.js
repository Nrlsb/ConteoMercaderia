...
async function runSQL() {
    console.log('Aplicando migración 029 (crear tabla color_registrations)...');
    
    const sqlPath = path.join(__dirname, 'migrations', '029_create_color_registrations.sql');
    ...
    if (error) {
        ...
        console.log('¡Migración 029 aplicada con éxito!', data);
    }
}

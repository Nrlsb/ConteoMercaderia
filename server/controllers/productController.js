    ...
    try {
        ...
        while (hasMore) {
            const { data, error, count } = await supabase
                .from('products')
                .select('id, code, barcode, barcode_secondary, description, brand, primary_unit, secondary_unit, conversion_factor, conversion_type, provider_description, provider_code, counting_category', { count: 'exact' })
